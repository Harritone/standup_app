class TeamsController < ApplicationController
  ...
  def set_users
    @account_users ||=
      ...
      current_account.users.with_role(:admin).distinct
  end

  def team_params
    params.require(:team).permit(:name, :description, :timezone, :has_reminder, :has_recap, :reminder_time, :recap_time, days: [], user_ids: [])
  end
